...
GLsizei ancho = 1024, alto = 768; // Tamaño de la ventana ajustado
...
int main(int argc, char** argv) {
    ...
    glutInitWindowSize(ancho, alto); // Ajustado para el tamaño de la ventana
    glutInitWindowPosition(100, 100); // Posición inicial de la ventana en la pantalla
    glutCreateWindow("Dibujar una linea");
    glutMouseFunc(mouse);
    gluOrtho2D(-(ancho / 2), ancho / 2, -(alto / 2), alto / 2); // Definir coordenadas
...
void Ejes() {
    // Dibuja los ejes X y Y en la ventana
